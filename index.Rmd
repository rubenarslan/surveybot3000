...
pt_plot_items2 <- pt_plot_items +
    annotate("text", size = 2.5, x = 0.2, y = -0.8, hjust = 1, label = "r(I fear for the worst,\nI never worry about anything)", color = "#00A0B0") +
  annotate("segment", x = 0.2, y = -0.8, xend = -0.3459711, yend = 0.2761906, color = "#00A0B0", alpha = 0.7) +
...
plot_rels2 <- plot_rels + 
  ...
  annotate("text", size = 2.5, x = -0.02, y = 0.85, hjust = 0, label = "LOT Optimism", color = "#00A0B0") +
...
plot_scales2 <- plot_scales +
  ...
  annotate("text", size = 2.5, x = -.1, y = -0.7, hjust = 0, label = "r(BFI Neur. Depression,\nLOT Optimism)", color = "#00A0B0") +
  annotate("segment", x = -.1, y = -.7, xend = -.34, yend = -.63, color = "#00A0B0", alpha = 0.7)


(pt_plot_items+
    pt_plot_rels + ggtitle("") +
    pt_plot_scales) /
