...
```{r fig.width = 8.3, fig.height = 5.5}
library(patchwork)
plot_rels2 <- plot_rels + 
  annotate("text", size = 3, x = 0.05, y = 0.99, vjust = 0, hjust = 0.09, label = with(accuracy_bayes_rels, { sprintf("accuracy = %.2f [%.2f;%.2f]", semi_latent_r, .lower, .upper) })) +
  annotate("text", size = 2.5, x = 0.5, y = 0.1, hjust = 0, label = "randomly formed scales", color = "#6A4A3C") +
  annotate("segment", x = 0.495, y = 0.1, xend = 0.396140, yend = 0.4864297, color = "#6A4A3C", alpha = 0.7) +
  annotate("segment", x = 0.495, y = 0.1, xend = 0.36230736, yend = 0.187590611, color = "#6A4A3C", alpha = 0.7) +
  annotate("text", size = 2.5, x = 0.63, y = 0.4, hjust = 0, label = "IPIP Extraversion", color = "#00A0B0") +
