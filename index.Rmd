...
scales <- scales %>%
  ...
  mutate(
    rel_real = list(psych::alpha(r_real_rev, keys = F, n.obs = N_real)$feldt),
    rel_llm = list(psych::alpha(r_llm_rev, keys = F, n.obs = N_real)$feldt),
    rel_pt_llm = list(psych::alpha(pt_r_llm_rev, keys = F, n.obs = N_real)$feldt)) %>%
